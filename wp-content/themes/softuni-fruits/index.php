...
<body>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 col-md-6 text-center">
					<div class="single-product-item">
						<div class="product-image">
							<a href="single-product.html"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/products/product-img-1.jpg" alt=""></a>
						</div>
						<h3>Strawberry</h3>
				...
				<div class="col-lg-4 col-md-6 text-center">
					<div class="single-product-item">
						<div class="product-image">
							<a href="single-product.html"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/products/product-img-2.jpg" alt=""></a>
						</div>
						<h3>Berry</h3>
				...
				<div class="col-lg-4 col-md-6 offset-md-3 offset-lg-0 text-center">
					<div class="single-product-item">
						<div class="product-image">
							<a href="single-product.html"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/products/product-img-3.jpg" alt=""></a>
						</div>
						<h3>Lemon</h3>
        	...
        	<div class="row clearfix">
            	...
            	<div class="image-column col-lg-6">
                	<div class="image">
                    	...
                    	<img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/a.jpg" alt="">
                    </div>
                </div>
                <!--Content Column-->
					...
					<div class="testimonial-sliders">
						<div class="single-testimonial-slider">
							<div class="client-avater">
								<img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/avaters/avatar1.png" alt="">
							</div>
						...
						<div class="single-testimonial-slider">
							<div class="client-avater">
								<img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/avaters/avatar2.png" alt="">
							</div>
							<div class="client-meta">
						...
						<div class="single-testimonial-slider">
							<div class="client-avater">
								<img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/avaters/avatar3.png" alt="">
							</div>
							<div class="client-meta">
				...
				<div class="col-lg-12">
					<div class="logo-carousel-inner">
						<div class="single-logo-item">
							<img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/company-logos/1.png" alt="">
						</div>
						<div class="single-logo-item">
							<img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/company-logos/2.png" alt="">
						</div>
						<div class="single-logo-item">
							<img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/company-logos/3.png" alt="">
						</div>
						<div class="single-logo-item">
							<img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/company-logos/4.png" alt="">
						</div>
						<div class="single-logo-item">
							<img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/company-logos/5.png" alt="">
						</div>
					</div>
				</div>
			</div>
	...
	<div class="copyright">
		<div class="container">
			<div class="row">
				<div class="col-lg-6 col-md-12">
					<p>This template is reworked from <a href="https://github.com/AtanasVasilev1992">Atanas Vasilev</a>.<br>
